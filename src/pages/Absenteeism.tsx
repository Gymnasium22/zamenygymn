    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-dark-800 p-5 sm:p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex flex-wrap items-center justify-start md:justify-end gap-2 sm:gap-3 w-full md:w-auto min-w-0">
                    <div className="flex min-w-0 bg-slate-100 dark:bg-dark-700 p-1 rounded-xl">
                        <button
                    ...
                    {viewMode === 'day' ? (
                        <DateInput
                            ...
                            className="min-w-0 flex-1 sm:flex-none px-3 sm:px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-dark-800 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        />
                    ) : (
                        <DateInput
                            type="month"
                    ...
                    <button
                        onClick={exportToPDF}
                        className="flex shrink-0 items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-colors shadow-lg shadow-indigo-200 dark:shadow-none"
                    >
