...
const IconMap: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    DoorOpen: (p) => (
        ...
        >
            ...
            <path d="M2 20h3" />
            <path d="M13 20h9" />
            <path d="M10 20v-6a2 2 0 0 1 2-2h1v1" />
            <path d="M13 12h1" />
            <path d="M5 20v-6a2 2 0 0 1 2-2h1v1" />
            <path d="M8 12h1" />
            <path d="M4 20v-8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8" />
        </svg>
    ),
    Bell: (p) => (
        <svg
    ...
    Eraser: (p) => (
        <svg
            ...
            strokeLinejoin="round"
        >
            <path d="M22 21h-4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2zm-4-4L6 4m0 0a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8" />
        </svg>
    ),
    Columns: (p) => (
        <svg
    ...
    Cloud: (p) => (
        <svg
            ...
            strokeLinejoin="round"
        >
            <path d="M17.5 19c0-1.7-1.3-3-3-3h-1.1c-.2-2.3-2.1-4-4.4-4-2.5 0-4.5 1.8-4.9 4.2-2.3.2-4.1 2.2-4.1 4.5 0 2.5 2 4.5 4.5 4.5h8.5c2.5 0 4.5-2 4.5-4.5z"></path>
        </svg>
    ),
    CloudRain: (p) => (
        <svg
