    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-1">
                <span className={`text-base font-bold ${isAbsent ? 'text-red-700 dark:text-red-400' : 'text-slate-700 dark:text-slate-300'}`}>{teacher.name}</span>
            ...
            <div className="flex justify-between items-end">
                ...
                {isAbsent && absenceReason && (
                    <div className="text-xs text-red-500 dark:text-red-400 italic font-medium">
                        {absenceReason}
                    </div>
                )}
            </div>
